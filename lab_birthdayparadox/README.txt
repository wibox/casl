To run the code with default parameters just run main.py. The simulator main variables:
...
can be modified via their respective flags (indicated by ->).
For example, to use a property upper bounded by 50, a different dataset and a different number of cardinalities:
python3 main.py --prop-upper-bound 50 --real-data <path/to/your/dataset> --num-instances <your_cardinalities>