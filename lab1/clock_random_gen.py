...
if __name__ == "__main__":
    ...
    while myClock.current_time < SIMULATION_TIME:
        #generate a new arrival_time every X secondss
        starttime = time.time()
        ...
        #increase queue length if only server is busy
        if(myServer.status==server_busy):
        ...
        print(f"Queue length: {customers_in_queue}")